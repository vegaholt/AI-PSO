...
public class SwarmSettings {
    public static SwarmSettings[] tasks = new SwarmSettings[]{
            new SwarmSettings("1a. 1D circle", 0.001, 100, 1, 1000, 0.9, 0.9, 0.2, 1.0, 0, 1000, 1, TypeOfSwarm.SIMPLE_SWARM),
            new SwarmSettings("1b. 10 Simulations", 0.001, 100, 1, 1000, 0.9, 0.9, 0.2, 1.0, 0, 1000, 10, TypeOfSwarm.SIMPLE_SWARM),
            new SwarmSettings("1c. 2D", 0.001, 100, 2, 1000, 0.9, 0.9, 0.2, 1.0, 0, 1000, 1, TypeOfSwarm.SIMPLE_SWARM),
            new SwarmSettings("2a. 1D Nearest Neighbours", 0.001, 100, 1, 1000, 0.9, 0.9, 0.2, 1.0, 3, 1000, 1, TypeOfSwarm.SIMPLE_SWARM),
